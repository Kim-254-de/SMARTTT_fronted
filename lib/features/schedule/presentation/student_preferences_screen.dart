...
class _StudentPreferencesScreenState extends ConsumerState<StudentPreferencesScreen> {
  ...
  // Distinct numbered sub-streams for the selected course+year, e.g. the
  // "1"/"2" in "BED.MATH/CHEM Y3S1(1)" / "...(2)" on the master timetable.
  // Empty when this course+year only has a single class (no picker needed).
  ...
  // Null when the course+year has no stream split to disambiguate.

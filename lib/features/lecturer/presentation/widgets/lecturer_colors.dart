...
/// Lecturer-module palette — distinct from the student app's royal-blue
/// theme (AppTheme.primary/accent) to match the SMARTClassCatch Lecturer
/// mockups: near-black navy header, warm orange CTAs.
class LecturerColors {
  static const Color navy = Color(0xFF12144A);
  static const Color navyDark = Color(0xFF0B0C33);
